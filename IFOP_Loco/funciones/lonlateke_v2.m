function lonlateke_v2(fname,Yorig,anio,imonth,year,step)
...
ax(i)=subplot(4,3,i);
lonlateke_v1(fname,Yorig,pos(1),pos(end),step,tname)
...
ylabel(barra,'EKE [cm^2/s^2] ','FontWeight','bold','FontSize',12);
...
cmap1=colormap_cpt('precip2 17lev');
% cmap1=flipud(cmap1);
for i=1:12
colormap(ax(i),cmap1)
end
