function hovmullerssslon_v2(fname,Yorig,anio,imonth,year,step)
...
ax(i)=subplot(4,3,i);
hovmullerssslon_v1(fname,Yorig,pos(1),pos(end),tname,step)
end
...
ax(2).Position(1)=[pos(1)-0.03];% pos(2) pos(3) pos(4)];
ax(5).Position(1)=[pos(1)-0.03];% pos(2) pos(3) pos(4)];
ax(8).Position(1)=[pos(1)-0.03];% pos(2) pos(3) pos(4)];
ax(11).Position(1)=[pos(1)-0.03];% pos(2) pos(3) pos(4)];

ax(3).Position(1)=[pos2(1)-0.06];% pos(2) pos(3) pos(4)];
ax(6).Position(1)=[pos2(1)-0.06];% pos(2) pos(3) pos(4)];
ax(9).Position(1)=[pos2(1)-0.06];% pos(2) pos(3) pos(4)];
ax(12).Position(1)=[pos2(1)-0.06];% pos(2) pos(3) pos(4)];
...
barra.Position=[pos2(1)+0.17 barra.Position(2) barra.Position(3) pos(2)+pos(4)-barra.Position(2)];
