function hovmullersss_v4(fname,Yorig,posi,posf,anio)
...
sstaux=squeeze(nc{'salt'}(posi:posi+aux(end),end,:,:));
for k=1:length(idx1)
...
title(['Climatology of zonally averaged modeled salinity'],'FontWeight','bold','FontSize',13)
