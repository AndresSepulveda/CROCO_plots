function lonvsdepth_temperature_v2(fname,lat1,NS,posi,posf,imonth,year,Yorig,anio,step)
...
ax(i)=subplot(4,3,i);
lonvsdepth_temperature_v1(fname,lat1,NS,pos(1),pos(end),imonth,year,Yorig,step,tname)
hold on
