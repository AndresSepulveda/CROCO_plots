function lonlatvaisala_v2(fname,Yorig,anio,imonth,year,step)
...
ax(i)=subplot(4,3,i);
lonlatvaisala_v1(fname,Yorig,pos(1),pos(end),step,tname)
...
ylabel(barra,'Brunt-Vaisala Frequency Squared [s^-2] ','FontWeight','bold','FontSize',12);
...
cmap1=colormap_cpt('temp_19lev');
for i=1:12
colormap(ax(i),cmap1)
caxis(ax(i),[-0.0001 0.0001])
end
